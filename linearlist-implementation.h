#ifndef DUCKDODGERS_LINEARLIST_IMPLEMENTATION_H
#define DUCKDODGERS_LINEARLIST_IMPLEMENTATION_H
...
template <typename ListType>
LinearList<ListType>::LinearList(const LinearList<ListType> &srcList) {
    ListNode<ListType>
            *src=srcList.head,
            **dest=&head;
...
#endif //DUCKDODGERS_LINEARLIST_IMPLEMENTATION_H
